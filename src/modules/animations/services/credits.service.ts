...
import { AiCreditLedgerEntry, LedgerReason } from '../entities/ai-credit-ledger.entity';
...
/**
 * Cobrança de créditos está DESLIGADA por padrão — o uso das funcionalidades de
 * IA é livre. O ledger continua implementado e testado; para religar a cobrança
 * basta `AI_CREDITS_ENABLED=true` no .env (nada mais precisa mudar).
 */
